...
class Waveunet(nn.Module):
    def __init__(self, n_src=2, n_inputs=1, kernel_size=15, merge_kernel_size=5, long_kernel_size=101, k_neurons=24, depth=7, n_first_filter=42):
    ...
    def forward(self, x_in, snr, inst=None):
        x = x_in
